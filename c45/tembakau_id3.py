...
dataset = pd.read_csv('tembakau.data',
...
def InfoGain(data, split_attribute_name, target_name="hasil"):
    """
...
def ID3(data, originaldata, features, target_attribute_name="hasil", parent_node_class=None):
    """
...
def test(data, tree):
    ...
    print('The prediction accuracy is: ', (np.sum(predicted["predicted"] == data["hasil"])/len(data))*100, '%')
